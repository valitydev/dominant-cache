...
import dev.vality.dominant.cache.DominantCacheApplication;
import dev.vality.dominant.cache.constant.CashNameConstant;
...
public class DominantCacheHandlerTest {
    ...
    void setup() {
        ...
        snapshot.setDomain(DomainObjectTestUtils.createTestDomainObject());
        cache.put(CashNameConstant.CACHE_NAME, snapshot);
    }
    ...
    void getCategoryTest() {
        ...
        assertEquals(dev.vality.damsel.dominant.cache.CategoryType.live, categoryList.get(2).getType());
        assertEquals(dev.vality.damsel.dominant.cache.CategoryType.test, categoryList.get(1).getType());
    }
